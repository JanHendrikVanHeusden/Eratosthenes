package nl.jhvh.eratosthenes.calculatedmultiplier

import nl.jhvh.eratosthenes.calculatedmultiplier.Eratosthenes.Prime
 ...
 * > See also [nl.jhvh.eratosthenes.calculatedmultiplier.noloop.Eratosthenes], this is identical but with
 *   a slightly different and apparently somewhat slower implementation of [Prime.isDivisorOf]
 *
 ...
 * > Con:
 *  * for higher counts up to 7 times slower than the classic "in memory" approach: 10M in ~ 190ms, 100M in ~ 28s
...
fun main() {
    println(">>> Calculated multipliers")
